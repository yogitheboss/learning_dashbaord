const roadmapData = {
  ...
  "2. Frontend Development": {
    ...
    "C. Responsive Web Design": {
      "Mobile-first design":
        "Ensure your website works on all devices (phones, tablets, desktops)",
  ...
  "3. Advanced Frontend Development": {
    "A. JavaScript Frameworks": {
      "React.js": ["Component-based architecture", "JSX", "Managing state"],
      "Other Options": ["Vue.js", "Angular"],
    },
    "B. TypeScript":
      "Adding static types to your JavaScript code to make it more scalable and maintainable",
    "C. State Management": {
  ...
  "4. Backend Development": {
    "A. Basics of Backend": {
      ...
      APIs: ["RESTful APIs", "HTTP methods (GET, POST, PUT, DELETE)"],
    },
    "B. Backend Languages": [
      "Node.js (JavaScript)",
      "Python (Django/Flask)",
    ...
    "C. Databases": {
      ...
      "Learn ORMs": ["Sequelize (Node.js)", "Prisma", "Mongoose (MongoDB)"],
    },
  ...
  "5. DevOps & Deployment": {
    "A. CI/CD":
      "Automate deployment using Jenkins, GitHub Actions, or Travis CI",
    "B. Cloud Platforms": {
    ...
    "E. Monitoring & Performance": ["New Relic", "Prometheus"],
  },
